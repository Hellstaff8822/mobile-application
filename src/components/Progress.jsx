...
export const Progress = () => {
  ...
  <div className="overall">
    <div className="overall__title">Your overall progress is <span>60%</span></div>
    <div className="overall__progress"></div>
  </div>
    ...
    <div className="questions-item">
      ...
      <div className="questions-item__sub">
        <div className="questions-item__desc">
          Lorem ipsum dolor sit amet, consectetur adipscing elit. Ut vel odio
          en urna ultrice...
        </div>
    ...
    <div className="questions-item item-two">
      ...
      <div className="item-two__sub">
        <div className="item-two__desc">
          This is demonstrate siblings, hobbies, efforts, confidence, friends
          and short tr...
        </div>
